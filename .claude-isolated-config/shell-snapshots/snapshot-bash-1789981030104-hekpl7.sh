...
if ! (unalias rg 2>/dev/null; command -v rg) >/dev/null 2>&1; then
  ...
  [[ -x $_cc_bin ]] || _cc_bin=/home/tamask/.local/bin/claude
...
export PATH=/home/tamask/.opencode/bin:/home/tamask/.nvm/versions/node/v22.23.2/bin:/usr/local/cuda/bin:/home/tamask/.local/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin:/snap/bin
